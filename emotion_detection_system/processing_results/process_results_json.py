...
results_path = os.path.join(emotion_detection_system_folder, 'json_results', 'data_experiments_nn_undersampling_010823')
batch_data_experiments = 'nn_undersampling_010823'
