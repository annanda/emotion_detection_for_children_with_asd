...
results_path = os.path.join(emotion_detection_system_folder, 'json_results', 'data_experiments_oversampling_random_050423')
batch_data_experiments = 'oversampling_random_050423'
