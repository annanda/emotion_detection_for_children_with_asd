...
DATE="04-09-23"
SLUG="data_experiments_nn_os_cross_annotation_040923"
ANNOTATION="parents"
INPUT_FOLDER="parents_nn_os_cross_annotation"
...
echo "Starting new Data Experiment Configuration: HSM_session_03_01_va_early_fusion_parents"
python entry_point.py ${INPUT_FOLDER}/HSM_session_03_01_va_early_fusion.json> ${OUTPUT_FOLDER}/${SLUG}_${ANNOTATION}_HSM_session_03_01_va_early_fusion_${DATE}.txt
