...
DATE="08-06-23"
SLUG="data_experiments_nn_ensemble_03_080623"
...
echo "Starting new Data Experiment Configuration: all_data_va_late_fusion_03.json"
python entry_point.py ${INPUT_FOLDER}/all_data_va_late_fusion_03.json> ${OUTPUT_FOLDER}/${SLUG}_${ANNOTATION}_all_data_va_late_fusion_03_${DATE}.txt
#
